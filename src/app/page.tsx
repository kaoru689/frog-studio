            ...
            <section className="py-24 bg-black relative overflow-hidden border-t border-cyber-primary/20" id="faq">
                ...
                <div className="max-w-3xl mx-auto px-6 relative z-20">
                    ...
                    <div className="space-y-4 font-mono">
                        {[
                            // 【技術・機能】
                            { q: "スコア保証は具体的に何点ですか？", a: "制作時の標準的な環境において、デスクトップ版90点以上、モバイル版80点以上を目安に最適化を行います。ただし、外部サービスの埋め込み状況等により変動する場合があります。" },
                            ...
                            { q: "すでにホームページを持っていますが、そこにLPを1枚だけ追加することはできますか？", a: "もちろん可能です！新規のお客様で「特定のキャンペーンや商品用にLPを1枚作りたい」という場合は、『LIGHTプラン（19,800円）』をご利用ください。現在運用中のサイト（WordPress等）との接続や、サブドメインでの公開設定などは、『独自ドメイン・既存サイト連携（5,000円）』オプションにてすべて代行いたしますので、技術的なことはすべて丸投げでOKです。" },
                            // 【制作プロセス】
                            ...
                            { q: "こちらで準備するものはありますか？", a: "使用したい写真やロゴなどの画像をご用意いただき、あとはヒアリングシートにお答えいただくだけでOKです。難しい設定や「何を書いていいか分からない」という部分は、AIと私でしっかりサポートしますので、丸投げに近い形でも進められます。" },
