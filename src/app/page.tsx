                        ...
                        {[
                            {
                                ...
                                sub: "爆速1ページLP",
                                price: "19,800",
                                features: ["1ページ完結の洗練されたLP", "スマホ・タブレット表示に完全対応", "お問い合わせフォーム設置", "基本的なSEO対策"],
                                delivery: "最短翌日納品",
                                isPopular: false,
                            ...
                            },
                            {
                                ...
                                sub: "信頼を築く王道プラン",
                                price: "49,800",
                                features: ["最大5ページ構成（トップ + 4ページ）", "microCMS連携（お知らせ・ブログ更新）", "モダンなアニメーション実装", "検索に強い高速表示設計", "緻密な内部SEO最適化"],
                                delivery: "最短5日納品",
                                isPopular: true,
                                bonus: "[FREE] アクセス解析標準装備 (GA4・サーチコンソール初期設定)"
                            },
                            {
                                ...
                                price: "98,000",
                                features: ["10ページ設計", "完全カスタムデザイン & ブランディング", "最高峰のUI/UXデザイン", "PageSpeed Insights 高スコア保証", "microCMS高度連携（カスタム投稿・マルチ管理）", "運用管理マニュアル・個別レクチャー付", "専用APIエンドポイント構築・最適化"],
                                delivery: "最短10日納品",
                                isPopular: false,
                                bonus: "[FREE] アクセス解析標準装備 (GA4・サーチコンソール初期設定)"
                            }
